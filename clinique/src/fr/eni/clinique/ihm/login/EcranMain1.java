...
public class EcranMain1 extends JFrame {
	public String role;
	static JFrame frame;
	EcranMain1 em = EcranMain1.this;

	public EcranMain1(String role, String nom) {
		this.role = role;
		...
		ImagePanel panel = new ImagePanel(new ImageIcon(
				"C:\\Users\\ttourgis2017\\Documents\\GitHub\\ProjetClinique\\clinique\\icon\\fond_frame.jpg")
						.getImage());
